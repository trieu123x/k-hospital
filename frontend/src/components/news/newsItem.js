        ...
        <div className="flex w-full h-[150px] bg-white border border-gray-100 overflow-hidden shadow-sm">
            ...
            <div className="flex flex-col ml-3 flex-1 justify-between py-2 pr-3">
                <div className="flex flex-col flex-1 min-h-0">
                    <div className="rasa-font font-bold text-[18px] leading-tight line-clamp-2 mr-1">
                        {data?.title}
                    </div>
                    <div className="rasa-font text-[16px] text-black font-normal line-clamp-2 mt-1 leading-snug">
                        {data?.content}
                    </div>
                </div>
                <div className="flex justify-between items-center text-[16px] mt-2">
                    ...
                    <Link
                        href={`/news/${data?.id}`}
                        className="rasa-font text-[11px] text-[#204CFF] italic hover:underline underline-offset-2 self-end mr-2"
                    >
                        Xem chi tiết
                    </Link>
                </div>
