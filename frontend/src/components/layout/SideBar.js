...
export function SideBar({ isAdmin = true, isDoctor = false, setSidebarClose = () => { } }) {
  ...
  return (
    ...
    `}>
      ...
      <LinkButton onClick={setSidebarClose} href="/doctors"
        className="hover:bg-[#050355] justify-start rounded-none">
        Bác sĩ
      </LinkButton>
...

      {
        isLookUpOpen &&
        <>
          <LinkButton onClick={setSidebarClose} href="/diseases"
            className="hover:bg-[#050355] justify-start rounded-none pl-10">
            Bệnh
          </LinkButton>

          <LinkButton onClick={setSidebarClose} href="/medicines"
            className="hover:bg-[#050355] justify-start rounded-none pl-10">
            Thuốc
          </LinkButton>
        </>
      ...
      <LinkButton onClick={setSidebarClose} href="/booking"
        className="hover:bg-[#050355] justify-start rounded-none">
        Đặt lịch khám
      </LinkButton>
...

      {
        isProfileOpen &&
        <>
          <LinkButton onClick={setSidebarClose} href="/profile"
            className="hover:bg-[#050355] justify-start rounded-none pl-10">
            Thông tin cá nhân
          </LinkButton>
          ...
          {isDoctor && <LinkButton onClick={setSidebarClose} href="/profile"
            className="hover:bg-[#050355] justify-start rounded-none pl-10">
            Lịch khám bệnh
          </LinkButton>}
        </>
