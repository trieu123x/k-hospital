...
export default function Navbar({ isAdmin = true, setSidebarOpen = () => { } }) {
  ...
  return (
    <nav className="flex h-15 xl:justify-between bg-[#070575] xl:bg-transparent">
      <div className={`
      ...
      <div className="hidden xl:flex w-1/5 justify-center items-center space-x-4">
        <LinkButton
          href="/login"
          className={`py-1.5
