...
export const notificationSchema = {
  body: z.object({
    ...
    appointmentId: z
      .uuid({ message: "appointmentId không hợp lệ" })
      .optional()
      .nullable(),
  ...
  query: z.object({
    userId: z.string().uuid({ message: "userId phải là UUID" }),
    lastId: z.string().uuid({ message: "lastId không hợp lệ" }).optional().nullable(),
  }),
